...
double Kp = 50000;
double Kd = 10000;
double Acc1, w1, wold1 = 110, qold1 = 0, qd1 = 1.05, qe1 = 0, C1, S1, Cal1 = 1200, Command1, F1;
double Acc2, w2, wold2 = 110, qold2 = 0, qd2 = 2.09, qe2 = 0, C2, S2, Cal2 = 1200, Command2, F2;
...
void loop()
{
  ...
  */
  //Serial.println((String) R + "A" + v1 + "C" + v2 + "D" + F1 / 468.085 + "E" + F2 / 468.085 + "F");
